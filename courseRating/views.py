...
#         course = get_object_or_404(Course, pk=course_id)
#         try:
#             rate_number = request.POST["rate"]
#         except:
#             render(request, "courseRating/rate.html", {"error_message":"Enter number for rate!"})
#
#         if rate_number <= 0 or rate_number > 10:
#             render(request, "courseRating/rate.html", {"error_message": "Enter number between 1 and 10!"})
#         course.count+=1
